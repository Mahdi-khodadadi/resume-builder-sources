...
const Resume104 = () => {
    ...
    return(
        <div className="Resume5" dir="ltr">
            <div className="Resume5-left" style={{width: "40%"}}>
                <div style={{display: "flex"}}>
                    <div style={{display: "flex", flexDirection: "column", justifyContent: "center"}}>
                        <h1>{form.firstName}{" "}{form.lastName}</h1>
                        <h2>{form.jobTitle}</h2>
                    </div>
                    <img src={image} alt="پریا دسای" class="profile-pic" style={{maxWidth: "9rem", display: (image) ? "block" : "none", border:"3px solid #ff6b3c"}} />
                </div>
            ...
            <div className="Resume5-right" style={{width: "60%"}} dir="rtl">
                <div style={{display: "flex", justifyContent: "space-between"}}>
                    <div className="Resume5-education" style={{display:  (form.insTitle) ? "flex" : "none", flexDirection: "column",alignItems: "flex-start", width: "49%"}}>
                    ...
                    <div className="Resume5-experience" style={{display:  (form.jobPosition) ? "flex" : "none", flexDirection: "column",alignItems: "flex-start", width: "49%"}}>
                ...
                <div style={{display: "flex", justifyContent: "space-between"}}>
                    <div className="Resume5-projects" style={{display: (form.proTitle) ? "block" : "none", width: "49%"}}>
                    ...
                    <div className="Resume5-projects" style={{display: (form.resTitle) ? "block" : "none", width: "49%"}}>
                ...
                <div className="Resume5-projects" style={{display: (form.lanName1 || form.lanName2 || form.lanName3) ? "flex" : "none", flexDirection: "column"}}>
