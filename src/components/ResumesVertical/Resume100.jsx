        ...
        <div className="resume1" dir="ltr">
            <div className="resume1-left">
                <div>
                    ...
                    <div className="resume1-section-title" style={{display : (form.DescMe) ? "block" : "none", borderBottom: "1px solid #ccc"}}>درباره من</div>
                        {form.DescMe}
                    <div className="resume1-section-title" style={{display : (form.mobile || form.telephon || form.email || form.addCounty) ? "block" : "none", borderBottom: "1px solid #ccc"}}>راه های ارتباطی</div>
            ...
            <div className="resume1-right">
                ...
                <div className="resume1-section" style={{display : (form.skillName1) ? "block" : "none"}}>
                    <h3>مهارت‌ها</h3>
                    <div style={{display: "flex"}}>
                        <div className="skl" style={{display: "flex", alignItems: "center", flexDirection: "column", width: "50%"}}>
                ...
                <div style={{display: "flex", direction: "rtl", justifyContent: "space-between"}}>
                    <div className="resume1-section" style={{display : (form.proTitle) ? "block" : "none", width: "48%"}}>
                        <h3>پروژه</h3>
                    ...
                    <div className="resume1-section" style={{display : (form.resTitle) ? "block" : "none",width: "48%"}}>
                        <h3>تحقیق</h3>
