...
const Resume101 = () => {
    ...
    return(
        <div className="resume2" dir="rtl" style={{display: "flex", margin:"50px 0", maxWidth: "none", fontFamily: "Vazir, sans-serif"}}>
            <div className="resume2-top-section">
                <div style={{display: "flex", alignItems: "center"}}>
                    <div className="resume2-profile-photo resume2-profile-photos" style={{display : (image) ? "block" : "none"}}>
                        <img src={image} alt="Sacha Dubois" className="imgs"/>
                    </div>
                    <div className="resume2-intro">
                        <h1>{form.firstName}{" "}{form.lastName}</h1>
                        <h2 style={{fontFamily: "Vazir"}}>{form.jobTitle}</h2>
                        <p>{form.DescMe}</p>
