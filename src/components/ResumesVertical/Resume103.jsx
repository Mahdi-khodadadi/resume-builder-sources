...
const Resume103 = () => {
    ...
    return(
        <div className="Resume4" dir="rtl" style={{margin: "50px 0", maxWidth: "none",padding: "20px", display: "flex"}}>
            <div style={{width: "50%"}}>
                <div className="Resume4-header" style={{justifyContent: "space-between", borderBottom: "none", margin: "20px 0 0 0"}}>
                ...
                <div className="Resume4-section" style={{display: (form.insTitle || form.jobPosition) ? "flex" : "none", justifyContent: "space-around"}}>
                    <div style={{display:  (form.insTitle) ? "block" : "none", width: "50%"}}>
                        <h2 style={{width: "98%"}}>سوابق تحصیلی</h2>
                    ...
                    <div style={{display:  (form.jobPosition) ? "block" : "none", width: "50%"}}>
                        <h2 style={{width: "98%"}}>سوابق شغلی</h2>
            ...
            <div style={{width: "50%"}}>
                <div className="Resume4-section" style={{display: (form.lanName1 || form.lanName2 || form.lanName3) ? "flex" : "none", justifyContent: "space-around", marginTop: "0"}}>
                    <div style={{width: "100%"}}>
                        <h2 style={{width: "98%"}}>زبان ها</h2>
