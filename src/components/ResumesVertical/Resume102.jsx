...
const Resume102 = () => {
    ...
    return(
        <div className="resume3" dir="rtl" style={{maxWidth: "1000px"}}>
            <div className="resume3-left-panel" style={{width: "40%"}}>
                <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                    <div className="resume3-image-container" style={{display: (image) ? "block" : "none"}}>
                        <img src={image} alt="Samir Khan" />
                    </div>
                    <div>
                ...
                <section style={{display: (form.gender || form.marital || form.year) ? "block" : "none"}}>
                    <h3>پروفایل</h3>
                ...
                <section style={{display: (form.mobile || form.telephon || form.web || form.addProvince) ? "block" : "none"}}>
                    <h3>تماس با من</h3>
                ...
                <section style={{display: (form.skillName1 || form.skillName2 || form.skillName3 || form.skillName4 || form.skillName5 || form.skillName6 ) ? "block" : "none"}}>
                        <h3>مهارت ها</h3>
                        <div className="resume2-item" style={{display: "flex", marginBottom: "0"}}>
            ...
            <div className="resume3-right-panel" style={{width: "60%"}}>
                <section style={{display: "flex"}}>
                    <div className="resume2-item" style={{display: (form.insTitle) ? "flex" : "none",flexDirection: "column", alignItems: "flex-start", width: "50%"}}>
                        <h3>📘 تحصیلات</h3>
                    ...
                    <div className="resume2-item" style={{display:  (form.jobPosition) ? "flex" : "none",flexDirection: "column", alignItems: "flex-start", width: "50%"}}>
                        <h3>🛠 تجربه کاری</h3>
                ...
                <section style={{display: (form.lanName1 || form.lanName2 || form.lanName3) ? "block" : "none"}}>
                        <h3>🌐 زبان ها</h3>
                ...
                <div style={{display: "flex"}}>
                    <section style={{display: (form.proTitle) ? "block" : "none", width: "50%"}}>
                        <h3>🔖 پروژه</h3>
                    ...
                    <section style={{display: (form.resTitle) ? "block" : "none", width: "50%"}}>
                        <h3>🔎 تحقیق</h3>
                            <div className="resume2-item" style={{display: "flex",flexDirection: "column", alignItems: "flex-start",gap: "3px"}}>
