...
const Resume3 = () => {
    ...
    return(
        <div className="resume3" dir="rtl" style={{maxWidth: "1000px"}}>
            <div className="resume3-left-panel">
            ...
            <div className="resume3-right-panel">
                <section>
                    <div className="resume2-item" style={{display: (form.insTitle) ? "flex" : "none",flexDirection: "column", alignItems: "flex-start", width: "100%"}}>
                        <h3>📘 تحصیلات</h3>
                    ...
                    <div className="resume2-item" style={{display:  (form.jobPosition) ? "flex" : "none",flexDirection: "column", alignItems: "flex-start", width: "100%"}}>
                        <h3>🛠 تجربه کاری</h3>
                ...
                <section style={{display: (form.proTitle) ? "block" : "none"}}>
                    <h3>🔖 پروژه</h3>
                ...
                <section style={{display: (form.resTitle) ? "block" : "none"}}>
                    <h3>🔎 تحقیق</h3>
                        <div className="resume2-item" style={{display: "flex",flexDirection: "column", alignItems: "flex-start",gap: "3px"}}>
